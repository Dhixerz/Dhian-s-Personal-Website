    ...
    >
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          ...
          <img
            src="https://ik.imagekit.io/Dhixerz/Personal%20Website/With%20background-square.jpeg"
            alt="Profile"
  ...
  const statsData = useMemo(() => [
    {
      ...
      description: "Innovative tech solutions crafted",
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I have a deep interest in Database Systems and am continuously improving my skills in this field. I am driven by the process of turning raw ideas into code that delivers tangible value. Believing in technology’s power to transform, I am dedicated to engineering impactful systems that help shape the future.
            </p>
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                "From a single line of code to infinity and beyond."
              </blockquote>
            </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1hBN43v0AL_qELZFqgSopSSYVKTE1cBGp/view?usp=drive_link" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
